...
public class implementTest
{
	...
	public static void main(String[] args)
	{
		...
		if(args.length != 4)
		{
			...
			System.out.println("java implementTest <bid file> <google 10000 file> <bids folder directory> <document folder directory>");
			System.exit(0);
		}
		...
		ArrayList<ArrayList<String>> bid = processBid(bidFile);
	 ...
	 */
	public static ArrayList<ArrayList<String>> processBid(String bidFile)
	{
	...
	/**
	 * Matching the words from the document to the keywords in the bids
	 * @param   [The words in the document]
	 * @param   [The processed bid file]
	 * @return  [The array of matched bids]
	 */
	public static ArrayList<ArrayList<String>> matchWords (ArrayList<String> document , ArrayList<ArrayList<String>> bid)
	{
		ArrayList<ArrayList<String>> fullyMatched = new ArrayList<ArrayList<String>>();
		for(ArrayList<String> keywords : bid)
		{
			int counter = 0;
	...
	/**
	 * Run subsequent bids to get the highest price of each keyword
